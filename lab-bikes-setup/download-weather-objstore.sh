...
curl "$SOURCE_PREFIX/weather-newark-airport.csv" | oci os object put --content-type text/csv --force --bucket-name $BUCKET_NAME --name "weather/weather-newark-airport.csv" --file -